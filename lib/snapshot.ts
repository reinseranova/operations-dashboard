...
function isValidSnapshot(v: unknown): v is Snapshot {
  ...
  return (
    ...
    !!s.summary &&
    typeof s.summary.ordersFulfilledToday === "number" &&
    typeof s.summary.returnsToday === "number" &&
    typeof s.summary.newReceivalsToday === "number" &&
    (s.summary.ordersCreatedTodayShopify === null ||
      typeof s.summary.ordersCreatedTodayShopify === "number")
  );
}
